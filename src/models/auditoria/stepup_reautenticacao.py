...
class StepUpReautenticacao(db.Model):
    ...
    def expirado(self):
        ...
        # Mesmo problema/fix de StepUpToken.expirado() (stepup.py):
        # alguns bancos/drivers devolvem o valor lido sem timezone,
        # mesmo a coluna sendo DateTime(timezone=True) -- normaliza
        # pra UTC antes de comparar, já que é sempre o que é gravado
        # (ver stepup_senha_confirmar em step_up.py).
