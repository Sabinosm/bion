from .user_interface import usuario
...
class user_enfermeiro(usuario):
    def __init__(
        ...
        self.numero_coren = numero_coren
        self.uf_coren = uf_coren
    ...
    def criar(self):
        ...
        #                 'numero_coren','uf_coren','especialidade')
        ...
        atributos={
            "numero_coren": self.numero_coren,
            "uf_coren": self.uf_coren,
